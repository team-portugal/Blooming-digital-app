...
<div style="width: 100%; max-width: 800px; margin: 0 auto; position: relative; text-align: center;">
  ...
  <div style="display: flex; overflow: hidden; position: relative; height: 450px;">
    <div style="display: flex; width: 500%; transition: transform 0.5s ease;
                transform: translateX(calc(-100% * (var(--slide, 0))));">
      ...
      <!-- Slide 3: Short film -->
      <div style="flex: 1 0 100%; padding: 20px;">
        <iframe width="100%" height="300" src="https://www.youtube.com/embed/aGex186Uz3A" 
          title="Short film about Livable Earth" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
        </iframe>
        <p><strong>🎬 Short film about Livable Earth</strong></p>
      </div>

      <!-- Slide 4: Web App Workshop -->
      <div style="flex: 1 0 100%; padding: 20px;">
        <iframe width="100%" height="300" src="https://www.youtube.com/embed/IsTd0S4hXU4" 
          title="Workshop about web app creation" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
        </iframe>
        <p><strong>💻 Workshop about web app creation</strong></p>
      </div>

      <!-- Slide 5: Local video -->
      <div style="flex: 1 0 100%; padding: 20px;">
        <video width="100%" height="300" controls>
          <source src="assets/slideshow de fotos.mp4" type="video/mp4">
  ...
  <div style="margin-top: 10px;">
    ...
    <label for="slide5" style="cursor: pointer; margin: 0 5px;">⬤</label>
  </div>
</div>

<style>
:has(#slide1:checked) { --slide: 0; }
:has(#slide2:checked) { --slide: 1; }
:has(#slide3:checked) { --slide: 2; }
:has(#slide4:checked) { --slide: 3; }
:has(#slide5:checked) { --slide: 4; }
</style>
...
As part of our Erasmus+ initiative, project partners actively disseminated the outcomes of Blooming Digital through educational platforms, conferences, and social media. Explore more below:

- 🔗 [Media & Learning Conference](https://conference.media-and-learning.eu/)
